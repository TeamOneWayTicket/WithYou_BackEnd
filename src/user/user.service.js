...
var UserService = /** @class */ (function () {
    //생성자
    function UserService(userRepository, localUserRepository) {
    ...
    UserService.prototype.findOneByEmail = function (nickname) {
    ...
    UserService.prototype.findLocalUser = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    UserService = __decorate([
        ...
        __param(1, typeorm_1.InjectRepository(local_user_entity_1.LocalUser))
    ], UserService);
    return UserService;
}());
