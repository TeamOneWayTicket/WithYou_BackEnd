...
var KakaoStrategy = /** @class */ (function (_super) {
    ...
    function KakaoStrategy(configService) {
    ...
    KakaoStrategy.prototype.validate = function (accessToken, refreshToken, profile, done) {
        return __awaiter(this, void 0, void 0, function () {
            var profileJson, kakaoId, user;
...
}(passport_1.PassportStrategy(passport_kakao_1.Strategy)));
